...
15. `src/air/ooda.ts` owns mission-track selection, no-contact mission direction, warning-track defensive geometry, and mission-completion decisions. It accepts observations, the aircraft's own state, and counts rather than world entities. A strike aircraft without a valid surface track continues its prebriefed heading or formation slot; it cannot turn toward a ship's truth transform.
