...
10. Air-to-air seeker and illumination eligibility lives in `src/air/guidance.ts`. The runtime supplies sensor geometry and signatures; AI defensive maneuver receives only `AirTrack` warning estimates, while target truth is limited to seeker measurement generation and physical hit resolution.
