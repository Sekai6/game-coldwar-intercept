...
- `src/ship-defense/launcher-runtime.ts`: Mk 10 task, slew, physical rail release, return-to-load, reload, casualty cancellation, and reset lifecycle; Mk 41 hatch opening, bank sequencing, physical vertical release, spent-cell closure, retained-round cancellation, trapped-round casualty handling, reset, and diagnostic snapshots. The scene layer injects tracks, health, ammunition, authorization settlement, interceptor creation, and visual effects rather than owning launcher phase transitions.
