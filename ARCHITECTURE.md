...
11. Countermeasure programs enqueue timed physical releases rather than applying a burst modifier in one frame. `src/air/flight-dynamics.ts` is the pure flight-envelope core; rendering consumes its bounded bank, pitch, speed, stall, and fuel-flow outputs.
