...
- `src/aar/acmi-exporter.ts`: pure AAR-to-Tacview ACMI 2.2 serializer. It assigns stable numeric object IDs, converts local east/north/altitude coordinates around a virtual reference point, emits object creation/update/deletion records, and carries AAR events into the Tacview timeline. Browser downloading is isolated in `src/aar/download.ts`.
